...
namespace HippoBilling.Core.Infrastructure
{
    /// <summary>
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether app should iterate assemblies in the app domain when loading app types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that assemblies arn't investigated (e.g. by not including something like "^XX|..." you may break core functionality.</remarks>
